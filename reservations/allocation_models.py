...
from applications.models import Application, ApplicationEvent, ApplicationPeriod
...
class AllocationData(object):
    def __init__(self, application_period: ApplicationPeriod):
        ...
        self.period_start: datetime.date = (
            application_period.reservation_period_begin
        )
        self.period_end: datetime.date = (
            application_period.reservation_period_end
        )
