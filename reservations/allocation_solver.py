...
class AllocationSolutionsPrinter(cp_model.CpSolverSolutionCallback):
    """Print intermediate solutions."""

    def __init__(self, events, sols):
...
class AllocationSolver(object):
    ...
    def solve(self):
        ...
        solver.SearchForAllSolutions(self.model, AllocationSolutionsPrinter(events={}, sols=range(5)))
        print("solver")
